...
},{}],"map-box.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZHVjZHV5MTYxMCIsImEiOiJjbDJ1OXZicmwwNGRhM2JubTQ1NGlpaWowIn0.ODPNjwJTTKjg_wc72e4vpQ";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/ducduy1610/cl2vpxaqo005u15peu9653eb4",
    scrollZoom: false // center: [106.7910673, 10.8712764],
    // zoom: 15,
    // interactive: false,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", (0, _alerts.showAlert)("error", "Name must not be empty!"));
          ...
          case 9:
            ...
            errorMessage = _context2.t0.response.data.error.code === 11000 ? "This email has already used!" : _context2.t0.response.data.message;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            endpoint = type === "password" ? "update-password" : "update-me";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
